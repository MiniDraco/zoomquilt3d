...
def _start_api_bat(b):
    ...
    if t == "a1111":
        ...
        return (
            ...
            "rem Pin versions this old WebUI needs on modern Python: setuptools\r\n"
            "rem <81 still ships pkg_resources (CLIP/open_clip build); numpy<2 +\r\n"
            "rem matching opencv (its compiled C modules need numpy 1.x).\r\n"
            "> \"%~dp0pip-constraints.txt\" echo setuptools^<81\r\n"
            ">> \"%~dp0pip-constraints.txt\" echo numpy^<2\r\n"
            ">> \"%~dp0pip-constraints.txt\" echo opencv-python^<4.11\r\n"
            ">> \"%~dp0pip-constraints.txt\" echo opencv-contrib-python^<4.11\r\n"
